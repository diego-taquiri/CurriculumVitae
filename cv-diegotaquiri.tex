...
PyTorch, Transformers, LLM, CNN, XGBoost.
}
\cvitem{}{\small \textbf{Toolbox:} 
Visual Studio Code, ssh, Tidyverse, Polars, Docker, LaTeX, ChatGPT.
}
\cvitem{}{\small \textbf{Bioinformatics:} 
scRNAseq, RNAseq, Genomics, Metagenomics, Phylogenetics, Methylomics, NGS, Biostatistics, Molecular docking, 3D Structure Prediction. 
}
