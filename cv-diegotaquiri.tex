...
\section{Skills}
\cvitem{}{\small \textbf{Programming:} 
R/RStudio, Python, Nextflow, AWS, GitHub, Bash, Unix. 
}
\cvitem{}{\small \textbf{Machine Learning:} 
PyTorch, Tensorflow, Large Language Models (LLM), CNNs, XGBoost
}
\cvitem{}{\small \textbf{Toolbox:} 
Visual Studio Code, ssh, Tidyverse, Polars, Docker, LaTeX.
}
\cvitem{}{\small \textbf{Bioinformatics:} 
RNAseq, scRNAseq, Genomics, Metagenomics, Epigenomics, Phylogenetics, Proteomics, NGS, Biostatistics, Molecular docking, 3D Structure Prediction. 
}
\cvitem{}{\small \textbf{Languages:} 
...
\section{GitHub Repositories}
  \cventry{2024}{\href{https://github.com/diego-taquiri/nanoGPT-DNA}{nanoGPT-DNA}}
    {Developed a lightweight GPT-like transformer model to learn the regulatory language of DNA sequences. Adapted nanoGPT to train on the human genome (hg38) using autoregressive training with nucleotide-level tokenization, with a focus on evaluating regulatory motif classification (Work in progress).}{}{}
    {}
