...
{\footnotesize \textit{GPA: 4.0/4.0, 16.8/20.0 in original scale (Top 20\% of the class)}.}  % arguments 3 to 6 can be left empty
\cventry{2017--2019}{B.S.E in Biomedical Engineering}
  ...
  {\footnotesize \textit{GPA: 4.0/4.0, 15.5/20.0 in original scale (Top 10\% of the class)}. Transitioned to a B.S. in Biology after 3 years of coursework.}
...
\footnotesize R/RStudio, Python, Nextflow, AWS, GitHub, Bash, Unix. 
}
\cvitem{}{\textbf{Machine Learning:} 
\footnotesize PyTorch, Transformers, LLM, CNN, XGBoost, Scikit-learn, pandas, numpy.
}
\cvitem{}{\textbf{Toolbox:} 
\footnotesize Visual Studio Code, ssh, Tidyverse, Polars, Docker, LaTeX, ChatGPT.
}
